    ...
    <a href={project?.link} target="blank">
      <div className="w-full h-80 rounded-lg bg-textBg p-7 flex flex-col justify-center gap-6 group">
        <div className="flex justify-between items-center">
          ...
          <RxOpenInNewWindow className="text-2xl hover:bg-designColor duration-200" />
        </div>
        <div>
        ...
        <ul className="text-xs md:text-sm md:text-darkText flex items-center gap-2 justify-between">
