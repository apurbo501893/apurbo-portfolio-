      ...
      <div className="max-w-[1440px] mx-auto flex items-center h-full justify-between">
        ...
        <div className="hidden md:inline-flex items-center gap-7">
          <div className="flex text-[13px] gap-7">
            {navigation?.map((item) => (
              <Link
                ...
                offset={-80}
                to={item?.link}
                className="font-[13px] hover:text-designColor cursor-pointer duration-300"
              >
                <motion.button
                ...
                >
                  ...
                  <spna className="uppercase tacking-wide">{item?.title}</spna>
                </motion.button>
              </Link>
            ))}
          </div>
          <motion.a
            ...
            href={resume}
            target="blank"
            className="px-4 py-2 text-designColor rounded-md font-medium text-[13px] tracking-wider uppercase border border-designColor hover:bg-hoverColor duration-200"
          >
            Resume
          </motion.a>
        </div>
        ...
        {show && (
          ...
          >
            ...
            >
              <MdOutlineClose className="text-3xl text-designColor hover:text-red-500 absolute top-4 right-4 duration-200 " />
